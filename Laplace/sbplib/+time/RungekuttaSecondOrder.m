classdef RungekuttaSecondOrder < time.Timestepper
    properties
        F
        k
        t
    ...
    methods
        ...
        function obj = RungekuttaSecondOrder(D, E, S, k, t0, v0, v0t, order)
            obj.D = D;
            obj.E = E;
            obj.S = S;
            obj.m = length(v0);
            ...
            [a,b,c,s] = time.rk_parameters(order);

            obj.butcher_tab = {a,b,c,s};
        ...
        function obj = step(obj)
            obj.w = time.rk_step(obj.w, obj.t, obj.k, obj.F, obj.butcher_tab);
            obj.t = obj.t + obj.k;
            obj.n = obj.n + 1;
        end
    end
