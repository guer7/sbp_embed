classdef Rungekutta6SecondOrder < time.Timestepper
    properties
        F
        k
        t
    ...
    methods
        ...
        function obj = Rungekutta6SecondOrder(D, E, S, k, t0, v0, v0t)
            obj.D = D;
            obj.E = E;
            obj.S = S;
            obj.m = length(v0);
        ...
        function obj = step(obj)
            obj.w = time.rk6.rungekutta_6(obj.w, obj.t, obj.k, obj.F);
            obj.t = obj.t + obj.k;
            obj.n = obj.n + 1;
        end
    end
    ...
    methods (Static)
        function k = getTimeStep(lambda)
            k = rk6.get_rk6_time_step(lambda);
        end
    end
